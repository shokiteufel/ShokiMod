...
public class MarkerSettingsScreen extends Screen {
    ...
    private static List<Row> rows() {
        ...
        return List.of(
                ...
                new Row("Floor drops", "Foraging drops lying on the ground, found by their spawn particle",
                        () -> c.enableFloorDrops, v -> c.enableFloorDrops = v,
                        c::floorDropColorRGB, rgb -> c.floorDropColor = hex(rgb), null),
